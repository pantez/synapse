...
from synapse.storage.data_stores.main.cache import CacheInvalidationStore
...
class CensorEventsStore(CacheInvalidationStore, EventsWorkerStore, SQLBaseStore):
